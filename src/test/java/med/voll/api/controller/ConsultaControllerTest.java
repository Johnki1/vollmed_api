...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deberia retornar estador http 400 cuando los datos ingresados sean validos")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deberia retornar estador http 200 cuando los datos ingresados sean validos")
    @WithMockUser
